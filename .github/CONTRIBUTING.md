...
Welcome, and thank you for your interest in contributing to **safe-glob**!
...
There are a couple of ways you can contribute to this repository:
  ...
  * **Ideas, feature requests and bugs**: We are open to all ideas and we want to get rid of bugs! Use the [Issues section](https://github.com/defenseunicorns-labs/safe-glob/issues) to either report a new issue, provide your ideas or contribute to existing threads.
...
Before you create a new Issue:
  ...
  * Check the [Issues](https://github.com/defenseunicorns-labs/safe-glob/issues) on GitHub to ensure one doesn't already exist.
